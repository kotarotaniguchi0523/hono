...
const cases = [
  ...
  {
    key: 'split-clients',
    name: 'Split domain RPC clients (100 routes available, 5 GET endpoints accessed)',
    config: 'tsconfig.split-clients.json',
    prerequisites: ['domain-authoring'],
  },
  {
    key: 'aggregate-client',
    name: 'Aggregate RPC client (100 routes available, 5 mounted GET endpoints accessed)',
    config: 'tsconfig.aggregate-client.json',
    prerequisites: ['domain-authoring', 'parent-composition'],
  },
...
const harnessFiles = [
  'cases/aggregate-client.ts',
  'cases/split-domain-clients.ts',
  'scripts/run-benchmarks.ts',
  'tsconfig.aggregate-client.json',
  'tsconfig.domain-authoring.json',
  'tsconfig.parent-composition.json',
  'tsconfig.split-clients.json',
  '../../bun.lock',
  '../../package.json',
  '../../tsconfig.base.json',
  '../../tsconfig.build.json',
